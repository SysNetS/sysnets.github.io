 ...
 **We are  looking for new PhD, Master, and Bachelor's students to join the team** [(see openings)]({{ site.url }}{{ site.baseurl }}/vacancies) **!**
...
{% for member in site.data.team_members_utd %}
...
# At Purdue
{% assign number_printed = 0 %}
{% for member in site.data.team_members_purdue %}
